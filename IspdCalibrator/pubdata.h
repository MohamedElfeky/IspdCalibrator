...
namespace mmr_conmunication {
    ...
    public:
        ...
        QByteArray toBinary()
        {
            ...
            qToLittleEndian(m_header, (unsigned char*)tmp + off);
            off += sizeof(m_header);

            qToLittleEndian(m_length, (unsigned char*)tmp + off);
            off += sizeof(m_length);

            qToLittleEndian(m_operator, (unsigned char*)tmp + off);
            ...
            QByteArray res((const char*)tmp, len);
            delete tmp;
            return res;
        }
    ...
    public:
        ...
        QByteArray toBinary()
        {
            ...
            QByteArray res((const char*)tmp, 381);
            return res;
        }
    ...
    public:
        ...
        QByteArray toBinary()
        {
            ...
            QByteArray res((const char*)tmp, 4);
            return res;
        }
