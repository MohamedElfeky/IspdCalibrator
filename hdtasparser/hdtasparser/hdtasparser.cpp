...
namespace hdtas
{
	...
	{
	public:
        message_in() :pkg_count_(1), pkg_id_(0) { this->msg_ = new po_message2(); }
...
/*
	...
	*/
	...
	{
	public:
        entity_in() : mid_(nullptr)  {};

		virtual ~entity_in() {}

        po_protocol_middle* mid_;
	};
	...
	{
	public:
        request_in(HDTAS_RD_WT_TYPE t) : rd_req_(nullptr), wt_req_(nullptr)
		{
        ...
        po_tcp_cfg_read_req* rd_req_;
        po_tcp_cfg_write_req* wt_req_;
	...
	{
	public:
        response_in(HDTAS_RD_WT_TYPE t) :rd_rpd_(nullptr), wt_rpd_(nullptr)
		{
			this->type_ = (HDTAS_RD_WT_TYPE::HRWT_READ == t ?
        ...
        po_tcp_cfg_read_rpd* rd_rpd_;
        po_tcp_cfg_write_rpd* wt_rpd_;
