...
#define LEN_MAX_DOMAIN_STRING (64) // Without terminated null-character('\0').
#define LEN_MAX_VERSION_STRING (16) // Without terminated null-character('\0').
#define LEN_MAX_MACADDR_STRING (12) // Without terminated null-character('\0').
...
#define TITLE_CONTROL_SERVER "[ctl server]"
...
#define TITLE_DATA_BASE_POLL "[mysql pool]"
...
#define NAME_JSON_KEY_UNIONON_ID "uid"
...
#define ERR_UPDATE_FILE_NAME_TOO_LONG -405
#define ERR_UPDATE_FILE_TYPE_NOT_SUPPORT -406
#define ERR_UPDATE_FILE_CORRUPED -407
#define ERR_UPDATE_FILE_NOT_FIND -408
#define ERR_UPDATE_DATA_UN_CONSISTENCY -409
#define ERR_CONTROL_NO_MSG_RESOURCE -410 // 消息队列中无消息资源
#define ERR_CONTROL_DATABASE -411
#define ERR_CONTROL_SID_NOT_CFG -412
...
#define DEBUG_REDIS_SUBSCRIBE_INFO 0

#define DEBUG_PRINT_RAW_DATA 0

// For protocol data parser.
#define DEBUG_PRINT_RAW_REGISTER 0
#define DEBUG_PRINT_RAW_MR_HEART_BEAT 0
#define DEBUG_PRINT_RAW_CONFIG_RD 0
#define DEBUG_PRINT_RAW_CONFIG_WT 0
#define DEBUG_PRINT_RAW_CONTROL 1

#define DEBUG_PRINT_RAW_ISPD_DATA 0
#define DEBUG_PRINT_RAW_MR_STATUS 0
#define DEBUG_PRINT_RAW_PB_STATUS 0

#define DEBUG_CONTROL_REQUEST_RESPONSE_DATA 1
// For protocol http parser.
#define DEBUG_PRINT_HTTP_CONTROL_RAW_DATA 1
#define DEBUG_PRINT_HTTP_CONTROL_CHECK_RAW_DATA 0
#define DEBUG_PRINT_HTTP_CONTROL_DATA_RAW_DATA 0

#define DEBUG_PRINT_STADIUM_SLOT 0

#define DEBUG_LABEL_INFO 1

#define DEBUG_MR_MESSAGE_INFO 1
#define DEBUG_MR_UPDATE_INFO 1
#define DEBUG_TIME_CONSUMING_INFO 0
#define DEBUG_DATABASE_UPDATE_INFO 1
