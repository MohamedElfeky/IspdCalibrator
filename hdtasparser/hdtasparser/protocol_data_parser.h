...
#define DEFAULT_TCP_CFG_RD_RPD_WITH_ERR_LEN (2+4+4) // N Total: 2+4+2 = 10 bytes.
...
#define POWER_BOARD_AUTO_REPORT_CLOSE 0X44
    ...
    public:
        ...
        inline void set_mmr_id( device_mr_id id ) { this->mmr_id = id; }
    ...
    private:
        ...
        h_uint32 static_ip_;
        h_uint32 static_netmask_;
        h_uint32 static_gateway_;
        h_uint32 static_dns_;

        h_uint32 dhcp_ip_;
        h_uint32 dhcp_netmask_;
        h_uint32 dhcp_gateway_;
        h_uint32 dhcp_dns_;
        ...
        po_network_type network_type_;
        po_network_select netmask_select_;

        po_wifi_mode wifi_mode_;
        po_dhcp_mode dhcp_mode_;
    };
    ...
    private:
        ...
        h_uint8 mr_report_interval_;

        device_mr_id mr_id_;
        device_mr_id mr_update_id_;
        h_uint32 mr_update_msg_id_;
