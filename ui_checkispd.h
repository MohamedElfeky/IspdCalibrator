...
public:
    ...
    void setupUi(QDialog *CheckIspd)
    {
        ...
        lineEdit_mmr_ip = new QLineEdit(CheckIspd);
        lineEdit_mmr_ip->setObjectName(QStringLiteral("lineEdit_mmr_ip"));
        lineEdit_mmr_ip->setFont(font);

        horizontalLayout_8->addWidget(lineEdit_mmr_ip);
